...
| Shell SixNode M2 | sei facce, rifiuto sostituzione, mapping direzioni e LRDU legacy coperti | non applicabile allo shell | non iniziato; nessun placeholder introdotto | non applicabile allo shell | schema versionato, round-trip, id sconosciuti validi e versioni future coperti; save nel mondo aperto | test automatici catalogo/shell/codec | parziale |
