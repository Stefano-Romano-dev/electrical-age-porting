...
| Scheduler e inizializzazione termica | formule di stabilità, forno, diodo e utility numeriche coperti | multi-rate, fasi slow, startup e fase tick server collegate | non applicabile | non applicabile | owner per server verificato all'avvio; stop da osservare | 18 test core + prova dedicated M1 | parziale |
